...
<script type="text/javascript">
    ...
    $(function(){
        ...
        /*    BJS.get('/pages/tablaCarrito?_t='+n,{},function(data){
         $('.tabla-carrito .content').html(data);
        ...
        $('#OrderTablaCarritoForm').validator({ lang: 'es', position:"top center"});
        $('#OrderCarritoForm').validator({ lang: 'es', position:"top center"});
