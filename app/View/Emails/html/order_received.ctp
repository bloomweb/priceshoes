		...
		<div style="margin-left: auto; margin-bottom: auto; margin-right: auto; margin-top: auto; max-height: 240px; max-width: 530px; min-height: 240px; min-width: 530px;">
			<table style="margin: auto; min-width: 524px; padding-right: 70px;">
				<tr>
					...
					<td width="60" align="center"><img alt="Price Shoes" src="<?php echo Configure::read('site_domain'); ?>/app/webroot/img/arrow_disabled_correos.jpg"></td>
					<td width="240" align="left"><img alt="Price Shoes" src="<?php echo Configure::read('site_domain'); ?>/app/webroot/img/check_disabled_correos.jpg"></td>
				</tr>
			</table>
